                        ...
                        while ($row = mysqli_fetch_array($cart_result)) {
                            ...
                            while ($row_product_price = mysqli_fetch_array($select_product_result)) {
                                ...
                                <tr class="d-flex flex-column d-md-table-row ">
                                    ...
                                    <td><img src="./admin/product_images/<?php echo $product_image_one; ?>" class="img-thumbnail"
                ...
                <div class="d-flex align-items-center gap-4 flex-wrap">
                    ...
                    if ($result_count > 0) {
                        ...
                        if (isset($_SESSION['username'])) {
                            echo '
                            <form method="POST" action="./users_area/checkout.php">
                                <input type="submit" value="Checkout" class="btn btn-primary" name="Checkout">
                            </form>
                           ';
                        } else {
                            $_SESSION['cart_pending'] = true;
                            echo '
                            <form method="POST" action="./users_area/user_login.php">
                                <input type="submit" value="Checkout" class="btn btn-primary" name="Checkout">
                            </form>
                           ';
                        }
