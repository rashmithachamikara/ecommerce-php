        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <?php
                        if(isset($_SESSION['username'])){                            
                            echo "
                            <li class='nav-item'>
                            <a class='nav-link' href='".SITE_URL."/users_area/profile.php'>My Account</a>
                        </li>";
                        }
                        else{
                            echo "
                            <li class='nav-item'>
                            <a class='nav-link' href='".SITE_URL."/users_area/user_registration.php'>Register</a>
                        </li>";
                        }
                    ?>
                </ul>
                ...
                <ul class="navbar-nav mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="<?=SITE_URL?>/cart.php"><svg width="28" height="28" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <?php
                        if(!isset($_SESSION['username'])){
                            $profile_link = SITE_URL."/users_area/user_login.php";
                        }else{
                            $profile_link = SITE_URL."/users_area/profile.php";
                        }
                    ?>
                    <li class="nav-item">
                    ...
                    if(!isset($_SESSION['username'])){
                        ...
                        <a class='nav-link' href='".SITE_URL."/users_area/user_login.php'>
                            Login
                        </a>
                    </li>";
                }else{
                        echo "<li class='nav-item'>
                        <a class='nav-link' href='".SITE_URL."/users_area/logout.php'>
                            Logout
                        </a>
                    </li>";
                    }
