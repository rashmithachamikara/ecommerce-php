        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= $currentPage == 'products.php' ? 'active' : '' ?>" href="<?= SITE_URL ?>/products.php">Products</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= $currentPage == 'about.php' ? 'active' : '' ?>" href="#">About</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= $currentPage == 'contact.php' ? 'active' : '' ?>" href="#">Contact</a>
                    </li>
                    <?php
                    if (isset($_SESSION['username'])) {
                        echo "<li class='nav-item'>
                            <a class='nav-link " . ($currentPage == 'profile.php' ? 'active' : '') . "' href='" . SITE_URL . "/users_area/profile.php'>My Account</a>
                        </li>";
                    } else {
                        echo "<li class='nav-item'>
                            <a class='nav-link " . ($currentPage == 'user_registration.php' ? 'active' : '') . "' href='" . SITE_URL . "/users_area/user_registration.php'>Register</a>
                        </li>";
                    }
                    ?>
                </ul>
                <form class="d-flex" action="<?= SITE_URL ?>/search_product.php">
                ...
                <ul class="navbar-nav mb-2 mb-lg-0">
                    ...
                    <?php
                    $profile_link = isset($_SESSION['username']) ? SITE_URL . "/users_area/profile.php" : SITE_URL . "/users_area/user_login.php";
                    ?>
                    <li class="nav-item">
                        <a class="nav-link" class="d-flex align-items-center gap-1" href="<?= $profile_link ?>">
                            <svg width="28" height="28" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <?php
                    if (!isset($_SESSION['username'])) {
                        echo "<li class='nav-item'><a class='nav-link' href='" . SITE_URL . "/users_area/user_login.php'>Login</a></li>";
                    } else {
                        echo "<li class='nav-item'><a class='nav-link' href='" . SITE_URL . "/users_area/logout.php'>Logout</a></li>";
                    }
                    ?>
                </ul>
            </div>
